...
// AI 분석 요청
export const analyzeQuestionService = async (questionId) => {
  try {
    const { data } = await axiosInstance.post(`/api/questions/${questionId}/analyze`);
    return data;
  } catch (error) {
...
// 분석 결과 조회
export const getQuestionAnalysisService = async (questionId) => {
  try {
    const { data } = await axiosInstance.get(`/api/questions/${questionId}/analysis`);
    return data;
  } catch (error) {
...
// 자동 분석 시작
export const startAutoAnalysisService = async (questionId) => {
  try {
    const { data } = await axiosInstance.post(`/api/questions/${questionId}/auto-analyze`);
    return data;
  } catch (error) {
